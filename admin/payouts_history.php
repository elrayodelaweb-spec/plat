...
$per = 30;
$start = ($page-1)*$per;
$stmt = $pdo->prepare("SELECT p.*, t.name AS tenant_name FROM payouts p LEFT JOIN tenants t ON t.id = p.tenant_id ORDER BY p.created_at DESC LIMIT :s,:n");
